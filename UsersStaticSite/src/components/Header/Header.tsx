...
function Header(): React.ReactNode {
  ...
  return (
    <div className="Header mx-auto " mx- id='home'>
      <motion.header
        animate={{ y: scrollDirection === 'down' ? -100 : 0 }}
        transition={{ type: 'spring', stiffness: 300, damping: 30 }}
        className="top-0 flex w-full items-center bg-primary justify-between lg:justify-center h-20 px-4 md:px-8 z-30"
        id='home'
      >
        <div className="app-container">
          <div className="Header_content flex w-full items-center justify-between lg:justify-center h-20 z-30">
