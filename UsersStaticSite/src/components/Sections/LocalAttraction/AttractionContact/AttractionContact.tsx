...
function AttractionContact(): React.ReactNode {
    ...
    <section className="pl-4 my-12 md:pl-0">
      ...
      <div className='flex flex-col gap-1'>
        <div className="flex gap-2">
          <p className='body-level-1 font-bold'>Telefone:</p>
          <a href="tel:+552498877-6655" className='body-level-1 font-normal'>(24)98877-6655</a>
        </div>
        <div className='flex gap-2'>
          <p className='body-level-1 font-bold'>Email:</p>
          <a href={`mailto:${''}`} className='body-level-1 font-normal'>exemplo@email.com</a>
        </div>
        <div className='flex gap-2'>
          <p className='body-level-1 font-bold'>Site:</p>
          <a href="google.com" className='body-level-1 font-normal'>www.site.com.br</a>
        </div>
        <div className="flex flex-col gap-1 xl:max-w-[420px]">
          <p className="body-level-1 h-fit z-10">Endereço:</p>
          <a href="">
            <address className="body-level-1 not-italic font-normal">
              Rua Ver. Arthur Marques dos Santos, 653, Bairro Santa Rita, Mendes, RJ, Brazil
            </address>
          </a>
        </div>
      </div>
