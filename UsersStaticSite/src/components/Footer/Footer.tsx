    ...
    <footer className="bg-offwhite dark:bg-lightGrey w-full" >
      ...
      <div className='flex flex-col sm:flex-row max-w-7xl mx-auto pl-4 pr-0 md:px-8 lg:px-16 py-12 md:py-20 items-start justify-between gap-8'>
        <section className='flex flex-col items-start gap-2 w-[280px] md:w-[320px] lg:w-[470px] mb-8'>
          ...
          <p className='text-level-1 font-normal'>O TurisMendes nasceu para valorizar a cultura, história e talentos de Mendes-RJ.</p>
          <p className='text-level-1 font-normal'>Através de placas turísticas com QR Codes e uma plataforma online interativa, o projeto conecta visitantes e moradores às riquezas locais.</p>
          <p className='text-level-1 font-normal'>Com o intuito de preservar o patrimônio e promover o turismo, o TurisMendes transforma a maneira como a cidade se apresenta ao mundo!</p>
        </section>
